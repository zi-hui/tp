...
public class ListCommand extends Command {
    ...
    public String listIngredients(ArrayList<Ingredient> ingredientList) {
        ...
        String[] categoryArray = {Dairy.INGREDIENT_WORD, Drink.INGREDIENT_WORD, Fruit.INGREDIENT_WORD, Meat.INGREDIENT_WORD,
                Miscellaneous.INGREDIENT_WORD, Staple.INGREDIENT_WORD, Vegetable.INGREDIENT_WORD};
    ...
    public String listRecipe(String itemNumber , ArrayList<Recipe> recipeArrayList) {
        ...
        if(recipeItem.getRecipeItem().size() == 0){
            ...
            for (int i = 0; i < recipeItem.getRecipeItem().size(); i++) {
                ...
                result += ingredientObj.getIngredientName() + " | " + ingredientObj.getCategoryName() + " | " + ingredientObj.getQuantity() + " | " +
                        ingredientObj.getPrice() + " | " + ingredientObj.getExpiryDate() + " \n";
            }
        }
        return result;
